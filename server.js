...
// app.use('/Registro Movimientos_Images', express.static(path.join(__dirname, 'Registro Movimientos_Images')));
   app.use('/INVENTARIOTQ_Images', express.static('C:\\Users\\efacamayo.TQCLO01\\OneDrive - Carvajal S.A\\1. Operación Carvajal\\1. Base de Datos Impresoras\\INVENTARIOTQ_Images'));
